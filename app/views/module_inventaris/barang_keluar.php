              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title float-left mt-3">Barang Keluar</h4>
                      ...
                      <table class="table table-striped table-bordered w-100" id="tblBarang">
                        ...
                        <?php foreach ($barang as $brg) :?>
                            <tr>
                                ...
                                <td><?= $brg->kuantitas_keluar ?> <?= $brg->satuan ?></td>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="nama_barang" id="nama_barang" class="form-control text-white" required="required">
              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <select name="keterangan" id="keterangan" class="form-control text-white" required="required">
