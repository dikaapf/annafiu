            ...
            <div class="card col-lg-8 mx-auto bg-transparan">
              <div class="card-body px-4 py-4">
                <div class="text-center">
                  ...
                  <h5 class="card-title mb-5 mt-2">An-Naafiu Versi <?= SIMASJID_VERSION ?></h5>
                </div>
                ...
                <div class="text-center mt-3">
                  <small class="text-white-50">Copyright &copy; 2023 - An-Naafiu by Mubaligh Teknologi Indonesia</small>
                </div>
                </form>
              </div>
            </div>
